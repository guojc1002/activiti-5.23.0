...
public class ProcessPermissions {
	...
	public void TsetUserCandidate() {
		...
		Deployment dep = repositoryService
				...
				.addClasspathResource(
						"processStored/processPermissions/bpmn/candidateUser.bpmn")
				.deploy();
		// 查询流程定义实体
	...
	@Test
	public void TsetGroupCandidate() {
		// 创建流程引擎
		ProcessEngine engine = ProcessEngines.getDefaultProcessEngine();
		// 得到流程存储服务实例
		RepositoryService repositoryService = engine.getRepositoryService();
		...
		Deployment dep = repositoryService
				.createDeployment()
				.addClasspathResource(
						"processStored/processPermissions/bpmn/candidateGroup.bpmn")
				.deploy();
	...
	@Test
	public void TsetCandidateQuery() {
		// 创建流程引擎
		ProcessEngine engine = ProcessEngines.getDefaultProcessEngine();
		// 得到流程存储服务实例
		RepositoryService repositoryService = engine.getRepositoryService();
		...
		Deployment dep = repositoryService.createDeployment()
				.addClasspathResource("processStored/processPermissions/bpmn/candidateQuery.bpmn").deploy();
		// 添加2个用户
